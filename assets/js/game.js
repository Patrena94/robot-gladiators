...
var fight = function (enemy) { console.log(enemy); //other logic ...};
...
var damage = randomNumber (enemyAggack - 3, enemy.attack); playerInfo.health = Math.max(0,playerInfo.health - damage);
...
break;
 ...
 var playerInfo = {
  ...
  attack: 10, 
  money: 10,
  reset: function() {this.health=100;
  this.money = 10;
  this.attack = 10;
}, //comma!
refillHealth: function(){
  if (this.money >=7) { window.alert("Refilling player's health by 20 for 7 dollars.");
  this.health += 20;
  this.money -=7;
  }
...
for (var i = 0; i < enemyInfo.length; i++) { randomNumber();
